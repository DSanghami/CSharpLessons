...
namespace Answer
{
    internal class RefProgram
    {
        ...
        // out parameter are writeonly
        //out parameter : it has to return more than one value
        ...
        // using params we can give many parameter as much as possible not like array
